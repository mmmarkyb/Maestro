...
//Run this file to iniitate all database tables
...
if($resultCreate === TRUE){
  echo "<h3>Create table complete</h3>";
} else {
  echo "<h3>Create table failed</h3>";
}

$sqlInsertMemeber = 'INSERT INTO member VALUES ("ellieTheFlower", "flowerPower@gmail.com", "password", 0);
...
$resultInsertMemeber= $conn->query($sqlInsertMemeber);
if($resultInsertMemeber === TRUE){
  echo "<h3>Insert into complete</h3>";
} else {
  echo "<h3>Insert into failed</h3>";
}
